...
Build a TODO app backend CRUD API on the [Internet Computer](https://internetcomputer.org/) using the [azle SDK](https://github.com/demergent-labs/azle). The app should have the following endpoints:
